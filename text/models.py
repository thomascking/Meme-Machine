...
class Subject(models.Model):
    ...
    weight = models.DecimalField(max_digits=10, decimal_places=8, default=.5)
...
class Meme(models.Model):
    ...
    def __str__(self):
        return 'When {0} {1} {2} {3}'.format(self.subject.text, self.verb.text, self.object.text, self.gerund.text)
